...
class lane_detection_network(nn.Module):
    def __init__(self):
        ...
        self.resizing = util_hourglass.resize_layer(3, 128)

        #feature extraction
        self.layer1 = util_hourglass.hourglass_block(128, 128)
        self.layer2 = util_hourglass.hourglass_block(128, 128)
        self.layer3 = util_hourglass.hourglass_block(128, 128)
        self.layer4 = util_hourglass.hourglass_block(128, 128)
